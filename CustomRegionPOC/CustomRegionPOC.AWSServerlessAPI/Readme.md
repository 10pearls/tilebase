...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *CustomRegionPOC.AWSServerlessAPI*):

Restore dependencies
```
    cd "CustomRegionPOC.AWSServerlessAPI"
    dotnet restore
```

Execute unit tests
```
    cd "CustomRegionPOC.AWSServerlessAPI/test/CustomRegionPOC.AWSServerlessAPI.Tests"
    dotnet test
```

Deploy application
```
    cd "CustomRegionPOC.AWSServerlessAPI/src/CustomRegionPOC.AWSServerlessAPI"
